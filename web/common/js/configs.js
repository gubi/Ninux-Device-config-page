		...
		option: [
			{
				...
				name: "hna4",
				value: "192.168.1.0",
				placeholder: "Indirizzo subnet IPv4",
				type: "text",
				title: "Inserisci la tua subnet IPv4 per la configurazione di OLSRd. Esempio: con 192.168.1.21/24 inserisci 192.168.1.0"
			},
			{
				text: "HNA6",
				name: "hna6",
				value: "2001:4c00:893b:cab::",
				type: "text",
				placeholder: "Indirizzo subnet IPv6 (senza prefisso)",
				title: "Inserisci la tua subnet IPv6 per la configurazione di OLSRd (come radvd) senza prefisso"
			},
			{
				text: "Prefisso LAN IPv6",
				name: "lan6prefix",
				value: "64",
				placeholder: "Prefisso IPv6",
				type: "number",
				title: "Inserisci il prefisso IPv6 per la configurazione di OLSRd"
			},
			{
				text: "Gateway",
				name: "gw_enable",
